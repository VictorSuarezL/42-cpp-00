...
void Phonebook::add(void)
{
    ...
    // ---------- First name (ASCII printable only) ----------
    str = "";
    while (!std::cin.eof() && str == "")
    {
        ...
        if (std::getline(std::cin, str) && str != "")
        {
            ...
            {
                if (!std::isprint(static_cast<unsigned char>(str[j])))
                {
                    ok = false;
                    break;
                }
            ...
            if (!ok)
            {
                std::cout << "Error: First name must contain only printable ASCII characters "
                             "(no accents/Ñ/UTF-8)."
                          << std::endl;
                str = "";
            }
    ...
    // ---------- Last name (ASCII printable only) ----------
    str = "";
    while (!std::cin.eof() && str == "")
    {
        ...
        if (std::getline(std::cin, str) && str != "")
        {
            ...
            if (!ok)
            {
                std::cout << "Error: Last name must contain only printable ASCII characters "
                             "(no accents/Ñ/UTF-8)."
                          << std::endl;
                str = "";
            }
    ...
    while (!std::cin.eof() && str == "")
    {
        ...
        if (std::getline(std::cin, str) && str != "")
        {
            ...
            if (!ok)
            {
                std::cout << "Error: Nickname must contain only printable ASCII characters "
                             "(no accents/Ñ/UTF-8)."
                          << std::endl;
                str = "";
            }
